//! Engine-independent world geometry, generation, and tile storage.
//!
//! The crate deliberately knows nothing about Bevy or a particular renderer.
//! Cube-sphere tiles are the stable contract shared by the desktop application,
//! analysis tools, and future simulation stages.
...
/// Common world-building types without cache implementation details.
pub mod prelude {
    pub use crate::{
